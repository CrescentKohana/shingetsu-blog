...
const ArticleCard = ({ article }: CardProps) => {
  ...
  if ((article.locale as Locale) === Locale.EN) {
    flag = <Image alt="English" src={englishSvg as StaticImport} height={40} width={40} priority />
  } else if ((article.locale as Locale) === Locale.JA) {
    flag = <Image alt="Japanese" src={japaneseSvg as StaticImport} height={40} width={40} priority />
  } else {
    flag = null
  }
