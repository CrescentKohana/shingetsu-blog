...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    image: Schema.Attribute.Media<"files" | "images"> & Schema.Attribute.Required
    locale: Schema.Attribute.String
    ...
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private
    visibility: Schema.Attribute.Enumeration<["showcased", "standard", "hidden"]> &
      Schema.Attribute.Required &
...
export interface ApiEcchiEcchi extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdAt: Schema.Attribute.DateTime
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private
    header: Schema.Attribute.Media<"images" | "files"> & Schema.Attribute.Required
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<"oneToMany", "api::ecchi.ecchi"> & Schema.Attribute.Private
    lowerContent: Schema.Attribute.RichText
    overlay: Schema.Attribute.Media<"files" | "images"> & Schema.Attribute.Required
    publishedAt: Schema.Attribute.DateTime
    sliders: Schema.Attribute.Component<"media.ecchi", true>
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 1
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private
    favicon: Schema.Attribute.Media<"images" | "files"> & Schema.Attribute.Required
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime
    selftyping: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 1
      }>
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime
    relation: Schema.Attribute.Enumeration<["created", "contributed", "endorsed"]> & Schema.Attribute.Required
    showcased: Schema.Attribute.Boolean & Schema.Attribute.Required & Schema.Attribute.DefaultTo<false>
    slug: Schema.Attribute.UID & Schema.Attribute.Required
    tech: Schema.Attribute.Component<"data.tech", true>
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiTokenToken extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<"oneToMany", "api::token.token"> & Schema.Attribute.Private
    publishedAt: Schema.Attribute.DateTime
...
export interface ApiWriterWriter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    avatar: Schema.Attribute.Media<"images" | "files"> & Schema.Attribute.Required
    createdAt: Schema.Attribute.DateTime
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private
    email: Schema.Attribute.String & Schema.Attribute.Private & Schema.Attribute.Unique
    locale: Schema.Attribute.String & Schema.Attribute.Private
