...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    token: Attribute.Relation<"plugin::users-permissions.user", "oneToOne", "api::token.token">
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    writer: Attribute.Relation<"api::article.article", "manyToOne", "api::writer.writer">
    ...
    visibility: Attribute.Enumeration<["showcased", "standard", "hidden"]> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false
...
export interface ApiEcchiEcchi extends Schema.SingleType {
  collectionName: "ecchis"
  info: {
    singularName: "ecchi"
    pluralName: "ecchis"
    displayName: "Ecchi"
  ...
  attributes: {
    ...
    header: Attribute.Media<"images"> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false
        }
      }>
    overlay: Attribute.Media<"images", true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false
        }
      }>
    sliders: Attribute.Component<"media.ecchi", true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false
        }
    ...
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    createdBy: Attribute.Relation<"api::ecchi.ecchi", "oneToOne", "admin::user"> & Attribute.Private
    updatedBy: Attribute.Relation<"api::ecchi.ecchi", "oneToOne", "admin::user"> & Attribute.Private
    localizations: Attribute.Relation<"api::ecchi.ecchi", "oneToMany", "api::ecchi.ecchi">
    locale: Attribute.String
  }
}
...
export interface ApiHomeHome extends Schema.SingleType {
  ...
  attributes: {
    ...
    localizations: Attribute.Relation<"api::home.home", "oneToMany", "api::home.home">
    locale: Attribute.String
  }
}
...
export interface ApiMediaUploadMediaUpload extends Schema.CollectionType {
  ...
  attributes: {
    ...
    file: Attribute.Media<"images" | "files" | "videos"> & Attribute.Required
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    createdBy: Attribute.Relation<"api::media-upload.media-upload", "oneToOne", "admin::user"> & Attribute.Private
    updatedBy: Attribute.Relation<"api::media-upload.media-upload", "oneToOne", "admin::user"> & Attribute.Private
  }
}
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<["created", "contributed", "endorsed"]> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false
    ...
    tech: Attribute.Component<"data.tech", true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false
        }
...
export interface ApiTokenToken extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user: Attribute.Relation<"api::token.token", "oneToOne", "plugin::users-permissions.user">
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    createdBy: Attribute.Relation<"api::token.token", "oneToOne", "admin::user"> & Attribute.Private
    updatedBy: Attribute.Relation<"api::token.token", "oneToOne", "admin::user"> & Attribute.Private
  }
}
